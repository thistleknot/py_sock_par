...
ssh slurm-w01 "runuser -l python_user -c 'LD_PRELOAD=/usr/local/cuda-11.5/targets/x86_64-linux/lib/libnvblas.so /mnt/distvol/py39_jupyterlab/bin/dask-worker tcp://192.168.3.100:8786 --resources 'GPU=1' --name CUDA --nprocs 1 --nthreads 1 --memory-limit=625MB >out.log 2>err.log &'";
