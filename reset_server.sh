...
ssh slurm-w01 "runuser -l python_user -c '/mnt/distvol/py39_jupyterlab/bin/dask-worker tcp://192.168.3.100:8786 --resources 'GPU=1' --nprocs 1 --nthreads 1 --memory-limit=768MB >out.log 2>err.log &'";
